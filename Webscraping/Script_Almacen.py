...
almacen_button = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/main/div[2]/section/div[2]/section[1]/div[1]/div[2]/div/div/div/div[2]/div/h6')))
almacen_button.click()
...
df.to_csv("Almacen.csv", index = False)   ##### LO GUARDO EN .CSV en la misma carpeta q ya tengo este script para probar
