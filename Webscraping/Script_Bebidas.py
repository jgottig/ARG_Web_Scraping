...
chromedriver_path = "/Users/jgott/chromedriver/chromedriver"

# Abro el sitio web y aprieto el botón Rosario
options = webdriver.ChromeOptions()
# Mantiene la sesión
options.add_experimental_option('detach', True)
options.add_argument("user-data-dir=\\Users\\jgott\\PerfilChrome")
...
bebida_sa_button = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/main/div[2]/section/div[2]/section[1]/div[1]/div[4]/div/div/div/div[2]/div/h6')))
bebida_sa_button.click()
...
df.to_csv("probando1234.csv", index = False)   ##### LO GUARDO EN .CSV en la misma carpeta q ya tengo este script para probar
